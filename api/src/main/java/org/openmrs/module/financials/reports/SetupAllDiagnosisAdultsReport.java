...
public class SetupAllDiagnosisAdultsReport extends AbstractHybridReportBuilder {
	...
	@Autowired
	public SetupAllDiagnosisAdultsReport(CommonDatasetDefinition commonDatasetDefinition) {
	...
	protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor descriptor, ReportDefinition report) {
		...
		dsd.setSqlQuery(Moh705Queries.getMoh705bQuery(4, opd.getEncounterTypeId()));
