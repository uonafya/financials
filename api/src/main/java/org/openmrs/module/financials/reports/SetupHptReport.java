...
@Component
@Builds({ "financials.moh.financial.summaries.pharmacy" })
public class SetupHptReport extends AbstractHybridReportBuilder {
	...
	protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor descriptor, ReportDefinition report) {
		...
		dsd.setName("hpt");
		dsd.setSqlQuery(MonthlyCollectionQueries.getHptSummary());
