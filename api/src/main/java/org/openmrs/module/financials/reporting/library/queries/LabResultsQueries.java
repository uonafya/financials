...
public class LabResultsQueries {
	...
	public static String getLabAdultsResultsQuery() {
		String sql = "SELECT * FROM (" + "SELECT person_id, " + "       identifier," + "       given_name, "
		        ...
		        + "                       t1.age, " + "                       t1.investigation, "
		        + "                       t1.encounter_datetime, " + "                       t1.value_numeric, "
		        + "                       t1.value_text, " + "                       t1.comments,t1.gender "
		        + "                FROM   (SELECT pn.given_name, " + "                               pn.person_id, "
		        + "                               pn.family_name, "
		        ...
		        + "										  AND pit.uuid ='61A354CB-4F7F-489A-8BE8-09D0ACEDDC63' "
		        ...
		        + "                 AND t2.locale_preferred " + ") adults " + " WHERE adults.person_id IN ("
	...
	public static String getLabChildrenResultsQuery() {
		String sql = "SELECT * FROM (" + "SELECT person_id, " + "       identifier," + "       given_name, "
		        ...
		        + "                       t1.value_text, " + "                       t1.comments, t1.gender "
		        + " FROM   (SELECT pn.given_name, " + "                               pn.person_id, "
		        + "                               pn.family_name, " + "                               pe.birthdate, "
		        + " pe.gender, " + "                               TIMESTAMPDIFF(YEAR, birthdate, :endDate) AS age, "
		        + "                               pi.identifier, "
		        + "                               cn.name AS Investigation, "
		        + "                               e.encounter_datetime, "
		        + "                               o.value_numeric, " + "                               o.value_text, "
