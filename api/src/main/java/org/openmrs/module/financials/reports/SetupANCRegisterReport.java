...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCCaCxScreeningResultsDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCClinicalNotesDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCCounselledDoneDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCDewormingDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCEDDUltrasoundDateDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCExercisesDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCFacilityReferredFromDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCFacilityReferredToDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCFinalTestResultsDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCGestationDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCGravidaDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCHIVTestOneDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCHaemoglobinDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCLmpDateDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCNVPDispensedDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCNumberOfVisitsDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCOtherIllnessesDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCParityDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCPartnerHIVStatusDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCPartnerTestedForHivDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCProphylaxisGivenDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCSupplimentDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCTBScreeningResultsDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCVLTestResultsDataDefinition;
...
public class SetupANCRegisterReport extends AbstractReportBuilder {
	...
	private Moh405ANCIndicatorDefinition anc;
	
	@Autowired
	public SetupANCRegisterReport(Moh405ANCIndicatorDefinition anc) {
		this.anc = anc;
	}
	...
	protected DataSetDefinition datasetColumns() {
		...
		dsd.setName("anc");
		dsd.setDescription("Visit ANC information");
		...
		dsd.addColumn("Next Appointment Date", new ANCNextAppointmentDateDataDefinition(), "", new DateConverter(
		        ENC_DATE_FORMAT));
	...
	protected DataSetDefinition ancRegisterAggregateDataSet() {
		...
		cohortDsd
		        .addColumn("fourthANC", "Fourth ANC visit", ReportUtils.map(anc.completed4AntenatalVisits(), indParams), "");
		...
		cohortDsd
		        .addColumn("knownPositives", "Known positive", ReportUtils.map(anc.knownPositivesFirstANC(), indParams), "");
		...
		cohortDsd.addColumn("screenedCaCxPap", "Screened CaCx PAP",
		    ReportUtils.map(anc.screenedForCaCxPAPAtANC(), indParams), "");
		cohortDsd.addColumn("screenedCaCxVIA", "Screened CaCx VIA",
		    ReportUtils.map(anc.screenedForCaCxVIAAtANC(), indParams), "");
		cohortDsd.addColumn("screenedCaCxVili", "Screened CaCx Vili",
		    ReportUtils.map(anc.screenedForCaCxViliAtANC(), indParams), "");
		...
		cohortDsd.addColumn("partnerKnownPositive", "Partner Known Positive",
		    ReportUtils.map(anc.partnerKnownPositiveAtANC(), indParams), "");
		cohortDsd.addColumn("adolescentsKnownPositive", "Adolescents Known Positive",
		    ReportUtils.map(anc.adolescentsKnownPositive_10_19_AtANC(), indParams), "");
		cohortDsd.addColumn("adolescentsTestedPositive", "Adolescents Tested Positive",
		    ReportUtils.map(anc.adolescentsTestedPositive_10_19_AtANC(), indParams), "");
		cohortDsd.addColumn("adolescentsStartedHaartAnc", "Adolescents Started Haart ANC",
		    ReportUtils.map(anc.adolescentsStartedHaart_10_19_AtANC(), indParams), "");
